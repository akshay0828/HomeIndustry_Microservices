...
<header className="App-header1">
        ...
        <Card.Header className={"heading"}><center>Vendor Details</center></Card.Header>
         <Card.Body>
           ...
           <tbody> 
            {
             ...
             &nbsp;<button className="btn" onClick={()=>this.approve(users.id)}><td>Approve</td></button>&nbsp;&nbsp;
             <button className="btn" onClick={()=>this.dissaprove(users.id)}><td>Dissapprove</td></button>&nbsp;
