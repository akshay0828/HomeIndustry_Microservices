...
class UpdateProduct extends React.Component{
  ...
  const result = axios.post("http://localhost:9000/api/vendor/updateProduct/"+id+"?productName="+this.state.productName+"&price="+this.state.price+"&weight="+this.state.weight+"&productDescription="+this.state.productDescription+"&quantity="+this.state.quantity);
alert(result);
            ...
            <MDBRow className='g-5'>
              ...
              <MDBCol md='6'>
                ...
                <MDBCardBody className='text-black d-flex flex-column justify-content-center'>
                  <h3 className="mb-5 text-uppercase fw-bold">Update PRODUCTS</h3>
                  ...
                  <MDBRow>
                    ...
                    <MDBCol md='12'>
                    <MDBInput wrapperClass='mb-5' label='Price' size='lg'  id="price" name="price" value={this.state.price} required placeholder="Price" onChange={this.onInputChange}  /> 
                    </MDBCol>

                  </MDBRow>

                  <MDBInput wrapperClass='mb-5' label='Weight' size='lg'  id="weight" name="weight"  value={this.state.weight} required placeholder="Weight" onChange={this.onInputChange}  /> 
                  ...
                  <MDBInput wrapperClass='mb-5' label='Quantity' size='lg'  id="quantity" name="quantity" value={this.state.quantity} required placeholder="quantity " onChange={this.onInputChange}  /> 
